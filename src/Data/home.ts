export const Homedata = {
    ...
    equations to enhance model interpretability.<br><br></p>
    ...
    and Technology</a>, graduating in June 2021, where I had the privilege of conducting research under the supervision of Professor
     ...
     and object detection techniques, alongside tackling the critical healthcare challenge of diagnosing pyrexia. 
     Post-graduation, from 2021 to 2022, I continued my research collaboration with Professor Haque while 
     simultaneously fulfilling my professional duties at Workera.<br><br></p>

    <p>In addition to my primary roles, I have been an Adjunct Lecturer at 
    <a href = "https://www.eastdelta.edu.bd/">East Delta University</a> since September 2023, 
    instructing courses in Mobile Computing, Digital Electronics and Pulse Techniques, Compiler Theory, and Computer 
    Graphics. From April 2024, I have been a Specialized Trainer at the 
    <a href = "https://skitbi-cuet.com/courses/ai-machine-learning-with-python-batch-2/">Sheikh Kamal IT Business Incubator</a> 
